...
import com.eckey.core.coins.FiatType;
import com.eckey.core.coins.FiatValue;
...
//    }
    ...
    /**
     * Parse a human readable fiat value to a {@link com.eckey.core.coins.Value} instance.
     *
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
